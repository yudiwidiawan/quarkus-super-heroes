...
import io.quarkus.workshop.superheroes.version.runtime.VersionRecoder;
...
class ExtensionVersionProcessor {
    ...
    void recordVersion(ApplicationInfoBuildItem app, VersionConfig versionConfig, VersionRecoder recorder) {
